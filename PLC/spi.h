...
#define CommReg (uint8_t)( ~ADC_DRDY &~ADC_RS2 &~ADC_RS1  &~ADC_RS0)  |ADC_RW
#define SetpReg (uint8_t)((~ADC_DRDY &~ADC_RS2 &~ADC_RS1)  |ADC_RS0) &~ADC_RW
#define ClckReg (uint8_t)((~ADC_DRDY &~ADC_RS2) |ADC_RS1) &~ADC_RS0  &~ADC_RW
#define DataReg (uint8_t)( ~ADC_DRDY &~ADC_RS2) |ADC_RS1   |ADC_RS0   |ADC_RW
#define ZeroReg (uint8_t)((~ADC_DRDY  |ADC_RS2  |ADC_RS1) &~ADC_RS0)  |ADC_RW
#define FullReg (uint8_t)  ~ADC_DRDY  |ADC_RS2  |ADC_RS1   |ADC_RS0   |ADC_RW
