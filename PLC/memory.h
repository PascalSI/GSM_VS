/*
	19.09.2012 - Kononenko - Comment TD_Mem
	10.01.2014 - —улима    - add 'struct DateBackUp' for saving data backup
	16.01.2014 - Kononenko - Add func uint8_t EEMEMBackUpOk(void)
*/
// ~~~~~~~~~~~~~~~~~~~
#ifndef _MEMORY_H_
#define _MEMORY_H_
...
typedef PGM_P PROGMEM prog_str;
...
static void CRC_EEPROM_upd(void);
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// EEPROM Memory Save & Restore
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
static struct {
	uint16_t CRC_Flash_stor, CRC_EEPROM_stor;
	uint8_t ReprogFlg;
} MemCheck_stor EEMEM;

enum {MemFail_Flash, MemFail_EEPROM};
uint8_t MemFail;

//структура дл€ хранени€ последней даты EEPROM-BackUP
